...
export const metadata: Metadata = {
  ...
  description:"A powerful project management tool with Kanban boards, task management, collaboration features, and real-time notifications. Organize workflows, track productivity, and enhance team collaboration with intuitive dashboards, calendar views, and analytics. Mobile responsive and available in dark mode."
}
...
export default function Home() {
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200">
      {/* Navbar */}
      <header className="flex justify-between items-center py-6 px-8 bg-white dark:bg-gray-800 shadow-md">
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-16 bg-gradient-to-b from-blue-500 to-blue-700 text-white">
